...
impl CommandCode {
    pub fn from_byte(b: u8) -> Option<Self> {
        match b {
            ...
            0x2A => Some(Self::GetAdvertPath),
            0x2B => Some(Self::GetTuningParams),
...
impl fmt::Display for CommandCode {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let name = match self {
            ...
            Self::GetAdvertPath => "CMD_GET_ADVERT_PATH",
            Self::GetTuningParams => "CMD_GET_TUNING_PARAMS",
...
impl ResponseCode {
    pub fn from_byte(b: u8) -> Option<Self> {
        match b {
            ...
            0x1A => Some(Self::AllowedRepeatFreq),
            0x1B => Some(Self::ChannelDataRecv),
...
impl fmt::Display for ResponseCode {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let name = match self {
            ...
            Self::AdvertPath => "ADVERT_PATH",
            Self::TuningParams => "TUNING_PARAMS",
            Self::Stats => "STATS",
            Self::AutoaddConfig => "AUTOADD_CONFIG",
            Self::AllowedRepeatFreq => "ALLOWED_REPEAT_FREQ",
            Self::ChannelDataRecv => "CHANNEL_DATA_RECV",
            ...
            Self::ContactsFull => "CONTACTS_FULL",
        };
        write!(f, "{name}")
    }
}
